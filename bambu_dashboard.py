...
async function testarBambuLan(){
  const c=_blCampos();
  _blErro("");
  if(!c.ip||!c.access_code||!c.serial){
    _blErro("Preencha o IP, o Código de Acesso e o Número de Série.");
    return;
  }
  ...
  if(wiz.step==="brand"){
    ...
    m.innerHTML=`
      ...
      <div class="wiz-body">
        ...
        <input id="bl_serial" placeholder="03919D571712715" value="${wiz.lan_serial||''}">
