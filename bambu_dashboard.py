...
function mostrarUpdateConcluido(nova){
  ...
  ov.innerHTML=`
    ...
    <div style="font-size:1.05rem;color:#aeb9cc;max-width:440px;line-height:1.6">
      Para usar a versão nova, <b style="color:#e8edf5">reinicie o computador.</b><br>
      Quando ligar de novo, o sistema abre sozinho já atualizado.</div>
    <div style="font-size:.85rem;color:#7a8699;max-width:440px;line-height:1.5">
      Pode reiniciar agora ou quando for melhor para você. Até lá, o sistema
      continua funcionando normalmente na versão atual.</div>`;
