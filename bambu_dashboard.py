...
function mostrarUpdateConcluido(nova){
  // tela clara e infalível: pede pra fechar e abrir. Sem reinício automático,
  // que dependia de detalhes do Windows e às vezes travava.
  ...
  ov.innerHTML=`
    ...
    <div style="font-size:1.3rem;font-weight:700">Atualizado para a versão ${nova||"nova"}!</div>
    <div style="font-size:1rem;color:#aeb9cc;max-width:420px;line-height:1.6">
      Falta um último passo para usar a versão nova:<br>
      <b style="color:#e8edf5">feche o sistema e abra de novo.</b></div>
    <div style="font-size:.9rem;color:#7a8699;max-width:420px;line-height:1.6">
      Feche pelo ícone na barra de tarefas (perto do relógio) com o botão direito → Sair,
      ou simplesmente feche a janela do programa e abra pelo atalho de sempre.</div>`;
