  ...
  box.innerHTML=`
    ...
    <div class="q-box">
      ...
      <div class="est-form">
        ...
        <label>Quantidade<span style="display:flex; gap:.4rem">
          <input id="estKg" type="text" inputmode="decimal" placeholder="Ex: 1" style="flex:1">
          <select id="estUnidade" style="width:auto; flex:0 0 auto">
