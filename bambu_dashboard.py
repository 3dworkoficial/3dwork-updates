    ...
    if url:
        ...
        try:
            ...
            r = _rq.post(f"{url}/api/ativar",
                         json={"licenca_id": key, "fingerprint": fp}, timeout=10)
            d = r.json()
            if d.get("ok"):
...
<style>
  ...
  *{box-sizing:border-box}
  ...
  .est-form input[type=color]{padding:.3rem; height:40px; cursor:pointer}
  ...
  *,*::before,*::after{box-sizing:border-box}
  ...
  .est-form input:not(.est-unidade),.est-form select:not(.est-unidade),
  .q-cli input,.q-cond input,.q-obs textarea,.q-table input,.q-table select{
    ...
    <div class="q-box">
      ...
      <div class="est-form">
        ...
        <label>Quantidade<span class="est-qtd-wrap">
          <input id="estKg" type="text" inputmode="decimal" placeholder="Ex: 1" class="est-qtd-input">
